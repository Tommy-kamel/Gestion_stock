          ...
          <nav class="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
            ...
            <div class="pt-2">
              ...
              >
                ...
                <svg :class="['w-4 h-4 transition-transform', openMenus.finances ? 'rotate-180' : '']" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                </svg>
              </button>
              <div v-show="openMenus.finances" class="pl-4 space-y-1 mt-1">
                <router-link to="/finances/validation" class="nav-sublink" active-class="active">
                  Validation demandes
                </router-link>
                <router-link to="/finances/caisses" class="nav-sublink" active-class="active">
                  Caisses
                </router-link>
                <router-link to="/finances/paiements-achats" class="nav-sublink" active-class="active">
                  Paiements fournisseurs
                </router-link>
                <router-link to="/finances/paiements-ventes" class="nav-sublink" active-class="active">
            ...
            <div class="pt-4 border-t border-slate-700">
              ...
              >
                ...
                <svg :class="['w-4 h-4 transition-transform', openMenus.referentiel ? 'rotate-180' : '']" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                </svg>
              </button>
              <div v-show="openMenus.referentiel" class="pl-4 space-y-1 mt-1">
                <router-link to="/referentiel/entreprises" class="nav-sublink" active-class="active">
                  Entreprises
                </router-link>
                <router-link to="/referentiel/fournisseurs" class="nav-sublink" active-class="active">
                  Fournisseurs
                </router-link>
                <router-link to="/referentiel/clients" class="nav-sublink" active-class="active">
                  Clients
                </router-link>
                <router-link to="/referentiel/personnel" class="nav-sublink" active-class="active">
                  Personnel
                </router-link>
              </div>
            </div>
